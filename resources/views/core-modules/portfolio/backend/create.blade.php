				...
				<div class="card-body">
					<div class="col-sm-10">
						...
						<div class="form-group">
							...
							<input id="category" type="text" name="data[category]" class="form-control category" required value="{{ request()->old('data.category') }}">
						...
						<div class="form-group">
							...
							<input id="asset" type="file" name="data[asset]" class="form-control asset" value="{{ request()->old('data.asset') }}" required="" accept="image/jpg, image/png, image/webp">
