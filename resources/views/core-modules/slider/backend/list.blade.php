	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<div class="content">
					<div class="row">
						<form method="post" action="{{ route('admin-slider-background-image') }}" enctype="multipart/form-data">
							<div class="col-md-12">
								<div class="form-group">
									<label>Background Image</label>
									<?php $background_image = (new \App\HelperModel)->getHelperValue('slider_background_image'); ?>
									@if($background_image)
										<img src="{{ route('get-asset', ['slider-background', $background_image]) }}" height="200px">
										<br/>
									@endif
