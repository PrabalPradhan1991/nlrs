		...
		<div class="card">
			<div class="card-header">
					<div class="d-flex align-items-center">
						<a href="{{ route('admin-testimonials-create-get') }}" class="btn btn-primary btn-round ml-auto">
								...
								<tr>
									...
									<td>
										<div class="form-button-action">
											...
											<a href="{{ route('admin-testimonials-edit-get', $d->id) }}" title="Edit" data-original-title="Edit" class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></a>
											<form method="post" action="{{ route('admin-testimonials-delete-post', $d->id) }}" class="prabal-confirm" id="delete-{{$d->id}}">
												{{ csrf_field() }}
											</form>
										</div>			
									</td>
